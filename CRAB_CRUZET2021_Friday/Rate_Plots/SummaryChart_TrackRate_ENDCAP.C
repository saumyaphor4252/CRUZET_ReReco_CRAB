...
//=========  (Sat Oct  2 23:52:18 2021) by ROOT version6.10/04
   TCanvas *canvas = new TCanvas("canvas", "canvas",419,80,986,870);
   gStyle->SetOptStat(0);
   canvas->Range(-2.508654,-0.00420996,13.21438,0.3251586);
   ...
   hb_ENDCAP__6->SetBinContent(1,0.1419766);
   hb_ENDCAP__6->SetBinContent(2,0.1068099);
   hb_ENDCAP__6->SetBinContent(3,0.1085881);
   hb_ENDCAP__6->SetBinContent(4,0.2860525);
   hb_ENDCAP__6->SetBinContent(5,0.2492225);
   hb_ENDCAP__6->SetBinContent(6,0.218361);
   hb_ENDCAP__6->SetBinContent(7,0.1795593);
   hb_ENDCAP__6->SetBinContent(8,0.1571647);
   hb_ENDCAP__6->SetBinContent(9,0.1251751);
   hb_ENDCAP__6->SetBinContent(10,0.09025329);
   hb_ENDCAP__6->SetBinContent(11,0.06447623);
   hb_ENDCAP__6->SetBinContent(12,0.0409805);
