...
//=========  (Sat Oct  2 23:52:16 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-1.881491,-0.00420996,9.910786,0.3251586);
   ...
   hb_TEC__2->SetBinContent(1,0.2860525);
   hb_TEC__2->SetBinContent(2,0.2492225);
   hb_TEC__2->SetBinContent(3,0.218361);
   hb_TEC__2->SetBinContent(4,0.1795593);
   hb_TEC__2->SetBinContent(5,0.1571647);
   hb_TEC__2->SetBinContent(6,0.1251751);
   hb_TEC__2->SetBinContent(7,0.09025329);
   hb_TEC__2->SetBinContent(8,0.06447623);
   hb_TEC__2->SetBinContent(9,0.0409805);
