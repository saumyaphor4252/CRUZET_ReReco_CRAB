...
//=========  (Sat Oct  2 22:02:36 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   can->Range(-1.634179,-0.4171845,8.523364,3.75466);
   can->SetFillColor(0);
   can->SetBorderMode(0);
   can->SetBorderSize(2);
   can->SetGridx();
   ...
   h1b__1->SetBinContent(1,3.178548);
   h1b__1->SetBinContent(2,1.794699);
   h1b__1->SetBinContent(3,0.04366801);
   h1b__1->SetBinContent(4,0.1048717);
   h1b__1->SetBinContent(5,0.837612);
   h1b__1->SetBinContent(6,0.2314166);
   h1b__1->SetBinContent(7,1.714698);
   h1b__1->SetBinContent(8,0.290916);
