...
//=========  (Sat Oct  2 22:02:37 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-2.508654,0.001090122,13.21438,0.2629182);
   ...
   hb_ENDCAP__6->SetBinContent(1,0.1115338);
   hb_ENDCAP__6->SetBinContent(2,0.08432001);
   hb_ENDCAP__6->SetBinContent(3,0.08766137);
   hb_ENDCAP__6->SetBinContent(4,0.2318312);
   hb_ENDCAP__6->SetBinContent(5,0.2042779);
   hb_ENDCAP__6->SetBinContent(6,0.180144);
   hb_ENDCAP__6->SetBinContent(7,0.1492171);
   hb_ENDCAP__6->SetBinContent(8,0.1314704);
   hb_ENDCAP__6->SetBinContent(9,0.1059625);
   hb_ENDCAP__6->SetBinContent(10,0.07748977);
   hb_ENDCAP__6->SetBinContent(11,0.05659263);
   hb_ENDCAP__6->SetBinContent(12,0.0370138);
