void CosmicRateTool_CosmicTrackRates_fromCSV(unsigned int runLow = 0, unsigned int runUp = 0) {

  FILE *pFile;
  pFile = fopen("tracksInfo.txt", "w");

  FILE *inputCSVfile;
  inputCSVfile = fopen("RunInfo_Output_20210926-011254.csv", "r");
  ...
  {
    std::cout<<"Tracks at "<<j<<" the Run "<<tracks.at(k)<<" out of total "<<nTotalTracks<<std::endl;
